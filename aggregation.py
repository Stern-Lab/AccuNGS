...
def aggregate_processed_output(input_dir, output_dir, reference, min_coverage, ref_mode):
    ...
    create_new_ref_with_freqs(reference_fasta_file=reference, freqs_file=freqs_file_path, min_coverage=min_coverage,
                              output_file=os.path.join(output_dir, "consensus_without_indels.fasta"), drop_indels=True, ref_mode = ref_mode )
    create_new_ref_with_freqs(reference_fasta_file=reference, freqs_file=freqs_file_path, min_coverage=min_coverage,
                              output_file=os.path.join(output_dir, "consensus_with_indels.fasta"), drop_indels=False, ref_mode = ref_mode )
