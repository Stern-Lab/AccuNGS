"""
This runs pbs_runner multiple times and gets its parameters from a json file containing the relevant parameters.
...
if __name__ == "__main__":
    ...
    for params_dict in params_list:
        ...
        args.update({key: value for key, value in params_dict.items() if value is not None})  # overide with params file args
