...
def multi_runner(params_list):
    ...
    for params_dict in params_list:
        ...
        job_id = pbs_runner(
            input_dir=args['input_dir'], output_dir=args['output_dir'], reference_file=args['reference_file'],
            max_basecall_iterations=args['max_basecall_iterations'], min_frequency=args['min_frequency'],
            ...
            align_to_ref=args['align_to_ref'], gmem=args['gmem'], stretches_pvalue=args['stretches_pvalue'],
